...
fun main(){
    ...
    var curso = Curso("FullStack", 20001, professorTitular, professorAdjunto, 40, listaAlunos)
    var curso1 = Curso("Android", 20002, professorTitular1, professorAdjunto1, 20, listaAlunos)
